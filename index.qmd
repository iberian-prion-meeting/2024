...
```{=html}
<h4>Get the <img class='schermostretto logotesto' src="figures/renfe.png"/><strong class='schermolungo'>renfe</strong> 5% discount</h4>
<div class="treno_dei_desideri">
  ...
  <div class="controllo_biglietti">
    Select in the <a href="https://www.renfe.com/es/en" target="_blank">RENFE webpage</a> the tickets you want.<br>
    Select the <strong>Congress/Events fee</strong> or <strong><em>Descuento de Congresos/Ferias</em></strong> in the drop-down menu.<br>
    Write <strong>TES/2024/00636</strong> in the Authorization Number/ "Número de autorización" box.<br>
  </div>
</div>
```
### Welcome
...
Registration deadline: [**23rd April 2024**](registration.qmd).
