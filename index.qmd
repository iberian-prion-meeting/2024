...
<script>
  window.onload = function() {
    var sections = document.querySelectorAll('.quarto-nav-section');
    sections.forEach(function(section) {
      section.classList.remove('quarto-nav-section-open');
      section.classList.add('quarto-nav-section-closed');
    });
  };
</script>